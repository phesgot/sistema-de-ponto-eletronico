    ...
    <div class="section" id="listaFuncionarios">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <h1>
              <i class="fa fa-fw fa-building"></i>Empresas</h1>
          </div>
          <div class="col-md-6">
            <div class="btn-group btn-group-justified">
              <a href='?pagina=cadastrar_emp' class="btn btn-dark"><i class="fa fa-fw fa-building"></i>Nova Empresa</a>
            </div>
          </div>
        </div>
      </div>
...
<?php
    ...
    if($consulta["status_emp"]==1 || $consulta["status_emp"]==2 || $consulta["status_emp"]==3){
?>
         <tr>          
					 <td>
					  <?php
